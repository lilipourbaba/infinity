		...
		<div class="variations" cellspacing="0" role="presentation">
			<?php foreach ($attributes as $attribute_name => $options) : ?>
				<div class="input-label">
					<label class="f-row c-3" for="<?php echo esc_attr(sanitize_title($attribute_name)); ?>">
						<b>انتخاب <?php echo wc_attribute_label($attribute_name); ?></b>
