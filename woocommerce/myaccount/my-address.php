	...
	<?php foreach ($get_addresses as $name => $address_title) : ?>
		...
		<div class="woocommerce-Address">
			<header class="woocommerce-Address-title title">
				...
				<a href="<?php echo esc_url(wc_get_endpoint_url('edit-address', $name)); ?>" variant="text-secondary" class="btn edit"><?php echo $address ? esc_html__('Edit', 'woocommerce') : esc_html__('Add', 'woocommerce'); ?></a>
			</header>
